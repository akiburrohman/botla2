...
`, attachment: fs.createReadStream(__dirname + "/cache/joinmp4/hello.gif")} ,threadID));
		...
		try {
			...
			(typeof threadData.customJoin == "undefined") ? msg = "Welcome {name}. to {threadName}\n{type} You are the {soThanhVien} member of this group.\n\nHI! I'm bot messenger use help to see command." : msg = threadData.customJoin;
			msg = msg
